...
<div class="col-lg-3 order-2 order-lg-1">
  ...
  <div class="py-2 px-4 bg-dark text-white mb-3"><strong class="small text-uppercase font-weight-bold">Alat Outdoor</strong></div>
  <ul class="list-unstyled small text-muted pl-lg-4 font-weight-normal">
    <li class="mb-2"><a class="reset-anchor" href="#">Tenda</a></li>
    <li class="mb-2"><a class="reset-anchor" href="#">Sleeping bag</a></li>
    <li class="mb-2"><a class="reset-anchor" href="#">Sepatu</a></li>
    <li class="mb-2"><a class="reset-anchor" href="#">Alat masak</a></li>
    <li class="mb-2"><a class="reset-anchor" href="#">Headlamp</a></li>
    <li class="mb-2"><a class="reset-anchor" href="#">Carrier</a></li>
  </ul>
...
<!--  <ul class="list-unstyled small text-muted pl-lg-4 font-weight-normal">
  ...
  <div class="custom-control custom-radio">
    ...
    <label class="custom-control-label text-small" for="customRadio2">Beli</label>
  </div>
  <div class="custom-control custom-radio">
    <input class="custom-control-input" id="customRadio3" type="radio" name="customRadio">
    <label class="custom-control-label text-small" for="customRadio3">Sewa</label>
  </div>
