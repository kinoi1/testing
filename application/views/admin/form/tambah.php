        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table">
                <form class="" action="<?= base_url('Admin/aksi_daftar_akun'); ?>" method="post">
                  <tr>
                    <td>Nama</td>
                    <td>:</td>
                  ...
                  <tr>
                    <td>Tanggal Lahir</td>
                    <td>:</td>
                    <td><input type="text" name="tgl_lahir" value="<?= set_value('tgl_lahir');?>"></td>
                  ...
                  <tr>
                    <td>Alamat</td>
                    <td>:</td>
                    <td><input type="text" name="alamat" value="<?= set_value('alamat');?>"></td>
                      <?= form_error('name','<small class=text-danger pl-3>','</small>'); ?>
                  </tr>
                  <tr>
                    <td>Password</td>
